...
function callvalue() {
    ...
    document.writeln("your info :  <br>"+"name: " +n +"<br>" );
    document.writeln("your email:" +email);
    document.writeln("your passward:" +passward);
...
function save_row(no)
{
 ...
 var grades_val=document.getElementById("grades_text"+no).value;
 var age_val=document.getElementById("age_text"+no).value;

 document.getElementById("name_row"+no).innerHTML=name_val;
 document.getElementById("grades_row"+no).innerHTML=grades_val;
